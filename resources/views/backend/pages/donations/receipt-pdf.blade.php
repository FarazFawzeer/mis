                ...
                <div class="receipt-title-row">
                    <div class="receipt-title-left">
                        ...
                        <div class="receipt-meta">
                            Donation Date: {{ optional($donation->donation_date)->format('Y-m-d') }}
                        </div>
                    </div>

                    <div class="receipt-title-right">
                        <div class="receipt-meta"><strong>Receipt No:</strong> {{ $receiptNo }}</div>
                        <div class="receipt-meta"><strong>Generated On:</strong> {{ now()->format('Y-m-d') }}</div>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div class="receipt-body">
                ...
                <table class="info-table">
                    <tr>
                        ...
                        <td class="value">{{ $donation->beneficiary_name ?? '-' }}</td>
                    </tr>
                    <tr>
                        <td class="label">Donation Type</td>
                        <td class="value">{{ $donation->donation_type ?? '-' }}</td>
                    </tr>
                    <tr>
                        <td class="label">Donation Date</td>
                        <td class="value">{{ optional($donation->donation_date)->format('Y-m-d') }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="value">
                            <span class="status-pill">{{ $donation->status }}</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="value">{{ $donation->remarks ?? '-' }}</td>
                    </tr>
                </table>
                ...
                <div class="amount-box">
                    ...
                    <div class="amount-box-body">
                        <div class="amount-value">
                            {{ $donation->amount !== null ? number_format($donation->amount, 2) : '0.00' }}
                        </div>
                    </div>
                </div>
