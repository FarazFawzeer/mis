        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarEmployees" data-bs-toggle="collapse" role="button"
                    aria-expanded="<?php echo e(request()->routeIs('admin.employees.*') ? 'true' : 'false'); ?>"
                ...
                <div class="collapse <?php echo e(request()->routeIs('admin.employees.*') ? 'show' : ''); ?>" id="sidebarEmployees">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="<?php echo e(route('admin.employees.create')); ?>">Create</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="<?php echo e(route('admin.employees.index')); ?>">View</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarDonations" data-bs-toggle="collapse" role="button"
                    aria-expanded="<?php echo e(request()->routeIs('admin.donations.*') ? 'true' : 'false'); ?>"
                ...
                <div class="collapse <?php echo e(request()->routeIs('admin.donations.*') ? 'show' : ''); ?>" id="sidebarDonations">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="<?php echo e(route('admin.donations.create')); ?>">Create</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="<?php echo e(route('admin.donations.index')); ?>">View</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse <?php echo e(request()->routeIs('admin.reports.*') ? 'show' : ''); ?>" id="sidebarReports">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="<?php echo e(route('admin.reports.donation.detailed')); ?>">Donation
                                Detailed</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="<?php echo e(route('admin.reports.employee.donation.summary')); ?>">Employee Donation
                                Summary</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="<?php echo e(route('admin.reports.donation.type.summary')); ?>">Donation Type Summary</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="<?php echo e(route('admin.reports.employee.master')); ?>">Employee
                                Master</a>
                        </li>
                    </ul>
                </div>
...
<?php /**PATH F:\Personal Projects\Infotech\cmi\resources\views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>